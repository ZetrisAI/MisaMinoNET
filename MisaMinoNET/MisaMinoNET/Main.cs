...
namespace MisaMinoNET {
    ...
    public class MisaMinoParameters {
        ...
        public MisaMinoParameters(
            int miny_factor = 13, int hole = 9, int open_hole = 17, int v_transitions = 10, int tspin3 = 29,
            int clear_efficient = 25, int upcomeAtt = 39, int h_factor = 2, int hole_dis_factor2 = 12, int hole_dis = 19,
            int hole_dis_factor = 7, int tspin = 24, int hold_T = 21, int hold_I = 16, int clear_useless_factor = 14,
            int dif_factor = 19, int strategy_4w = 0
        ) {
        ...
        public static MisaMinoParameters FromArray(int[] arr) {
            if (arr.Length != 17) throw new ArgumentException();
